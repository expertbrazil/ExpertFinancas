            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseConfig" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link {{ request()->routeIs('planos.*') ? 'active' : '' }}" href="{{ route('planos.index') }}">
                ...
                <div class="collapse" id="collapseRelatorios" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ route('relatorios.servicos') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-concierge-bell"></i></div>
                            Serviços
                        </a>
                        <a class="nav-link" href="{{ route('relatorios.produtos') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-box"></i></div>
                            Produtos
                        </a>
                    </nav>

            ...
            <form action="{{ route('planos.update', $plano) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $plano->name) }}" required>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        @if($plano->image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $plano->image) }}" 
                                     alt="{{ $plano->name }}" 
                                     class="img-thumbnail" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('monthly_price', number_format($plano->monthly_price, 2, ',', '.')) }}" required>
                        </div>
                        @error('monthly_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('semiannual_price', number_format($plano->semiannual_price, 2, ',', '.')) }}" required>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('annual_price', number_format($plano->annual_price, 2, ',', '.')) }}" required>
                        </div>
                        @error('annual_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              id="description" name="description" rows="4" required>{{ old('description', $plano->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="active" name="active" value="1" 
                               {{ old('active', $plano->active) ? 'checked' : '' }}>
